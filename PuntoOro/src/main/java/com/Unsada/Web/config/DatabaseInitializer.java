    ...
    public CommandLineRunner initializeCanchas(CanchaRepository canchaRepository) {
        return args -> {
            if (canchaRepository.count() == 0) { // Solo si no hay canchas en la base de datos
                ...
                Cancha cancha2 = new Cancha(null, LocalTime.of(8, 0), LocalTime.of(22, 0), true, LocalTime.of(1, 0), EstadoCancha.OCUPADA);
                Cancha cancha3 = new Cancha(null, LocalTime.of(8, 0), LocalTime.of(22, 0), true, LocalTime.of(1, 0), EstadoCancha.TURNO_FIJO);
                Cancha cancha4 = new Cancha(null, LocalTime.of(8, 0), LocalTime.of(22, 0), true, LocalTime.of(1, 0), EstadoCancha.RESERVADA_PARA_TORNEO);
